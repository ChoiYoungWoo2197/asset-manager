  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> 업체정보관리 <small></small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">기초정보</a></li>
              <li class="breadcrumb-item active">업체정보관리</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="col-lg">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input id="search" type="search" class="form-control" placeholder="업체명" v-model="search">
    ...
    <!-- 모달 컴포넌트  -->
    <PartnerCompanyCreate ref="partnerCompanyCreate" @updateData="handleUpdateData" style="display: none"></PartnerCompanyCreate>
    <PartnerCompanyUpdate ref="partnerCompanyUpdate" @updateData="handleUpdateData" style="display: none"></PartnerCompanyUpdate>
    <!-- /모달 컴포넌트  -->
  </div>
  <!-- /.content-wrapper -->
</template>
...
export default {
  ...
  methods: {
    searchData() {
      const vm = this;
      axios.get('http://localhost:8080/api/partner-companys', {
        params: {
          page : vm.currentPage,
          size : vm.perPageNum,
          useYn: $('#useYn').val(),
    ...
    showCreateModal() {
      this.$refs.partnerCompanyCreate.clearData();
      $('#partner-company-create-modal').modal("show");
    },
    showUpdateModal() {
      $('#partner-company-update-modal').modal("show");
    },
    handleUpdateData() {
      this.currentPage = 0;
      this.searchData();
    ...
    clickTrTag(data){
      this.$refs.partnerCompanyUpdate.setData(data);
