...
import java.util.*;
public class AssetRentalLogSpecification {
    public static Specification<AssetRentalLog> searchWith(Map<String, Object> searchKeyword) {
        return (Specification<AssetRentalLog>) ((root, query, builder) -> {
            List<Predicate> predicate = getPredicateWithKeyword(searchKeyword, root, builder);
            return builder.and(predicate.toArray(new Predicate[0]));
        });
    }

    private static List<Predicate> getPredicateWithKeyword(Map<String, Object> searchKeyword, Root<AssetRentalLog> root, CriteriaBuilder builder) {
