...
public class PartnerCompanySpecification {
    public static Specification<PartnerCompany> searchWith(Map<String, Object> searchKeyword) {
        return (Specification<PartnerCompany>) ((root, query, builder) -> {
            List<Predicate> predicate = getPredicateWithKeyword(searchKeyword, root, builder);
            return builder.and(predicate.toArray(new Predicate[0]));
        });
    }

    private static List<Predicate> getPredicateWithKeyword(Map<String, Object> searchKeyword, Root<PartnerCompany> root, CriteriaBuilder builder) {
